...
const Navbar = () => {
  ...
  return (
    <nav className='bg-white py-6 px-12 flex items-center justify-between shadow-md
        ...
        <Link href={'#hero'} className='font-bold text-xl hover:text-[#147efb] text-[#2d2e32] ease-in-out duration-500'
        data-aos='fade-right'>
            Alex.dev
        </Link>
        ...
        <div className='hidden md:flex flex-row gap-4 font-semibold text-md'>
            <Link href={'#hero'}
                className='hover:text-[#147efb] text-[#2d2e32] ease-in-out duration-500'
                data-aos='fade-left'
            >
                Home
            </Link>
